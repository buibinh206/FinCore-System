            ...
            <div class="col-lg-10 col-xl-9">
                <div class="card form-card">
                    ...
                    <div class="form-header">
                        ...
                        <p>Cập nhật hồ sơ nhân viên trong hệ thống quản lý ngân hàng</p>
                    </div>
                    ...
                    <div class="form-body">
                        <form action="<?= url('employee-update') ?>" method="POST">
                            ...
                            <div class="section-title">
                                <i class="bi bi-pencil-square me-2"></i>Thông tin nhân viên
                            </div>
